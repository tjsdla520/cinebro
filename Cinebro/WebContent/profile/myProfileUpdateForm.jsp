   ...
   <div class="container" align="center">
      <div>
         <div style="margin-top: 50px">
            <h2 align="center" style="color: white">회원 정보 수정</h2>
         </div>
         <br> <br> <br>
         <form name="myform" class="form-horizontal" action="<%=YesForm%>"
            ...
            <div class="form-group">
               <h5><label class="control-label col-sm-<%=formleft%>" for="email"
                  style="color: white">변경할 닉네임</label></h5>
               <div class="col-xs-3">
                  <input type="text" class="form-control" id="nickname" placeholder="변경할 닉네임 입력하세요"
            ...
            <div class="form-group" style="margin-top: 20px">
               <h5><label class="control-label col-sm-<%=formleft%>" for="filmtitle1"
                  style="color: white">좋아하는 영화 제목</label></h5>
               <div class="col-xs-3">
            ...
            <div>
               <div class="form-group" style="margin-top: 20px">
                  <h5><label class="control-label col-sm-<%=formleft%>" for="genre"
                     style="color: white">좋아하는 영화 장르</label></h5>
                  <div class="col-xs-3">
